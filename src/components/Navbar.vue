      ...
      <div class="flex items-center justify-between sm:p-0">
        ...
        <div class="sm:hidden">
          <button
            @click="isOpen = !isOpen"
            type="button"
            class="block text-white hover:text-gray-300 focus:text-white focus:outline-none"
          >
